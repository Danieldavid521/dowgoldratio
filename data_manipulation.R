...
dia_url <- 'https://finance.yahoo.com/quote/DIA/'
gold_url <- read_html('https://finance.yahoo.com/quote/GC=F/')

gold_scraped <- gold_url %>% html_elements(xpath = "//*[@id=\"main-content-wrapper\"]/section[1]/div[2]/div[1]/section/div/section/div[1]/div[1]/span")
gold_url %>% html_elements(css="up1.yf-ipw1h0.base")
head(gold_scraped)
element:
